...
# Specify the column names
    Categories_Competitions_columns = ['category_id','category_id','category_name','competition_id','competition_name','parent_id','type','gender']
    Complexes_Venues_columns = ['complex_id','complex_id','complex_name','venue_id','venue_name','city_name','country_name','country_code','timezone']
    CompetitorRankings_Competitors_columns = ['competitor_id','competitor_id','rank_id','rank','movement','points','competitions_played','name','country','country_code','abbreviation']
